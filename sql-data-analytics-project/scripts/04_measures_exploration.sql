...
UNION ALL
SELECT 'Total Quantity', SUM(quantity) FROM DataWarehouseAnalytics.fact_sales
UNION ALL
SELECT 'Average Price', AVG(price) FROM DataWarehouseAnalytics.fact_sales
UNION ALL
SELECT 'Total Orders', COUNT(DISTINCT order_number) FROM DataWarehouseAnalytics.fact_sales
UNION ALL
SELECT 'Total Products', COUNT(DISTINCT product_name) FROM DataWarehouseAnalytics.dim_products
UNION ALL
SELECT 'Total Customers', COUNT(customer_key) FROM DataWarehouseAnalytics.dim_customers;
